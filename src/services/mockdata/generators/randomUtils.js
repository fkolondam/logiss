...
const getRandomStatus = (statusConfig) => {
...
const getRandomCoordinates = (centerLat, centerLng, radiusInKm) => {
...
const generateInvoiceNumber = (branch, date, index) => {
  const branchCodes = {
    "RDA SUMEDANG": "241110",
...
const generateProofImageUrl = (branch, invoice) => {
...
const getFuelLevel = (baseLevel, time) => {
